...
import { Check, ChevronRight, ClipboardPenLine, Plus, Ruler, Search, X } from 'lucide-react';
...
export function FrontDeskMeasurementsView() {
  ...
  return <div className="space-y-7">
    ...
    {selected && <ProfileDetails profile={selected} onClose={() => setSelected(null)} onEdit={() => { setEditor(selected); setSelected(null); }} />}
